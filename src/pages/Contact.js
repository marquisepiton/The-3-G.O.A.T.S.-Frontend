      ...
      <div className="container">
          <div className="card" style={{ width: "18rem" }}>
              ...
              <ul className="list-group list-group-flush">
                    ...
                    <ul className="social-icons">
                        ...
                        <li>
                          <a className="facebook" href="#">
                            <div className="fa fa-facebook"></div><img src="../img/facebook.png"/>
                          </a>
                        </li>
                        <li>
                          <a className="twitter" href="#">
                            <i className="fa fa-twitter"></i><img src="../img/facebook.png"/>
                          </a>
                        </li>
                        <li>
                ...
                <li className="list-group-item">Email: pitonmarquise@gmail.com</li>
              </ul>
            </div>
      </div>
      </div>
